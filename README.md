...
* You can also test out the package from the command line (after installing) by running ```transaction_assessment train-model --limit 100000```. Removing the limit flag will use all of the data.
